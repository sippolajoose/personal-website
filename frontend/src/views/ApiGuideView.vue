...
<template>
  <section class="api-guide-shell">
    <header class="api-guide-header panel">
      <div>
        <p class="eyebrow">API Guide</p>
        <h1 class="section-title" style="font-size: 2rem; margin: 0 0 10px">Interactive OpenAPI docs</h1>
        <p class="subtle">
          Click through the endpoints, inspect request bodies, and try the API directly from this page.
        </p>
      </div>
      <a class="button-secondary" :href="openApiUrl" target="_blank" rel="noreferrer">Open raw OpenAPI JSON</a>
    </header>

    <section class="panel api-guide-panel">
      <div v-if="!scalarLoaded" class="api-guide-loading">Loading interactive docs…</div>
